...
@section('content')
    ...
    {{-- Sezione intera della pagina di edit --}}
    <section id="arpartment-edit-section">

        {{-- Controllo tra ID del proprietario dell'appartamento loggato --}}
        {{-- Se coincidono mostra la pagina --}}
                ...
                <div class="card">
                    ...
                    <div class="card-body py-3">
                        ...
                        <form action="{{ route('admin.apartments.update', $apartment) }}" method="POST">
                            ...
                            <input type="hidden" name="user_id" id="user_id" value="{{ $apartment->user_id }} required">
                                            ...
                                            <div class="row">
                                                @foreach ($services as $service)
                                                    <div class="col-2">
                                                        ...
                                                        <input @checked(in_array($service->id, old('services', $apartment->services->pluck('id')->all()))) type="checkbox"
